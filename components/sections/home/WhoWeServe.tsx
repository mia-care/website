...
const COPY = {
  en: {
    pill: "Who We Serve",
    heading: "Every company carries the weight of regulated software.",
    cta: { label: "Platform Overview →", href: "/product" },
  },
  it: {
    pill: "Chi Serviamo",
    heading: "Ogni azienda porta il peso del software regolamentato.",
    cta: { label: "Panoramica della Piattaforma →", href: "/it/prodotto" },
  },
};

export function WhoWeServe({ locale = "en" }: { locale?: "en" | "it" }) {
  const t = COPY[locale];
