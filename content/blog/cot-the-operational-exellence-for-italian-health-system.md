...
featuredImage: "/blog/images/cot-the-operational-exellence-for-italian-health-system.webp"
featuredImageAlt: "Territorial Operative Center (COT): the future of the Italian healthcare system"
excerpt: "Italy aims to reform the national healthcare system by implementing a territorial care model that brings people and their care …"
---

Italy aims to reform the national healthcare system by implementing a [territorial care model](https://www.pnrr.salute.gov.it/portale/pnrrsalute/dettaglioContenutiPNRRSalute.jsp?lingua=italiano&id=5828&area=PNRR-Salute&menu=comecambiassn) that brings people and their care and prevention needs closer to healthcare facilities and operators. How? Thanks to the funds allocated by the NRRP, which, once the pandemic emergency is over, aims to rationalize and streamline the national health care system.

To this end, a [reform of the organizational model of](https://www.pnrr.salute.gov.it/portale/pnrrsalute/dettaglioContenutiPNRRSalute.jsp?lingua=italiano&id=5898&area=PNRR-Salute&menu=riforme) the territorial care network based on:
...
The COT (Territorial Operations Center) is defined as a territorial [organizational model](https://www.agenas.gov.it/images/agenas/In%20primo%20piano/COT/Lettura_digital_Quaderno_COT.pdf) that aims to ensure continuity, accessibility, and integration of care and assistance.
...
Precisely because of this need for innovation, also tied with a collective responsibility to improve the quality of the care provided, the NRRP funds will allow the development of [at least 600 COT](https://www.pnrr.salute.gov.it/portale/pnrrsalute/dettaglioContenutiPNRRSalute.jsp?lingua=italiano&id=5875&area=PNRR-Salute&menu=investimenti) to take on citizens’ requests and link them with available services and professionals, **ensuring continuity, accessibility, and integration of health and social-health care.**
...
- ~ EUR 25 million for the Enhancement of the [Transparency Portal](https://www.portaletrasparenzaservizisanitari.it/).
...
Supporting this new care structure will have to, at a logical-functional level, make the [following tools](https://www.agenas.gov.it/images/agenas/In%20primo%20piano/COT/Lettura_digital_Quaderno_COT.pdf) available to the operators:
...
![](/blog/images/cot-the-operational-exellence-for-italian-health-system-1.webp)

Source: [Quaderno di Monitor](https://www.agenas.gov.it/comunicazione/primo-piano/2184-la-centrale-operativa-territoriale-dalla-realizzazione-all%E2%80%99attivazione) “La Centrale Operativa Territoriale: dalla realizzazione all’attivazione” – Published by AGENAS, 2022.
