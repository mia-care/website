...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/it/chi-siamo" },
  description:
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-10">
          <div>
            ...
            <p className="text-base" style={{ color: "var(--text-secondary)", lineHeight: 1.8 }}>
              Mia-Care nasce per contribuire alla salute e al benessere dell'umanità, offrendo
              l'esperienza di cura più efficace a ogni paziente e medico. Portiamo l'innovazione in
              sanità al successo con un'architettura moderna che abilita servizi digitali
              data-driven sempre più estesi, interconnessi, sicuri e intelligenti.
            </p>
          </div>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <div className="flex-1">
              ...
              >
                Mia-Care è un'azienda del gruppo Mia-Platform. Mia-Platform è l'AI-Native Developer
                Platform di riferimento per grandi enterprise di tutto il mondo per costruire ed
                eseguire a scala prodotti cloud-native governati dall'AI, riconosciuta da una
