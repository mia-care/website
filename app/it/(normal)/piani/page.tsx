...
const TIERS = [
  ...
  },
  {
    ...
    description:
      "Insight su misura, compliance AI/ML automatizzata e validazione degli strumenti per team che vogliono muoversi rapidamente.",
    features: [
      "1 azienda · 5 prodotti · 10 utenti",
      "Tutto quanto incluso in Standard",
      "Smart Insight & AI Assistant su misura",
...
const COMPARISON: { label: string; values: [CellValue, CellValue, CellValue] }[] = [
  ...
  { label: "Smart Insight", values: ["Default", "Su misura", "Su misura"] },
  {
...
const DISTRIBUTION = [
  ...
  },
  {
    ...
    description:
      "Distribuisci P4SaMD sulla tua infrastruttura — cloud privato o on-premise. Pensato per organizzazioni con requisiti stringenti di data residency, sovereign cloud o isolamento di rete.",
    points: [
...
const FAQ = [
  ...
  },
  {
    ...
    a: "Sì. P4SaMD è modulare per design. Puoi iniziare con SDLC Orchestrator e Guided Workflows, per poi espandere all'intero set di capability man mano che le tue esigenze evolvono.",
  },
  {
