...
export const metadata: Metadata = {
  title: { absolute: "Panoramica della Piattaforma AI-native per SaMD | Mia-Care" },
  description:
  ...
  alternates: { canonical: "/it/prodotto", languages: localeAlternates("/it/prodotto") },
};
...
const BENEFITS = [
  ...
  },
  {
    ...
    body: "P4SaMD automatizza i task manuali ripetitivi lungo tutto il ciclo di vita dello sviluppo (dall'esecuzione automatica dei test agli aggiornamenti della documentazione): la velocità di engineering aumenta, senza rinunciare a una compliance rigorosa.",
  },
];
...
const WHY = [
  ...
  {
    title: "Flessibilità e modularità",
  ...
  },
  {
    ...
    body: "Le normative cambiano di continuo. P4SaMD si aggiorna insieme a loro, così il tuo team può concentrarsi su quello che deve costruire davvero.",
  },
];
