...
export const metadata: Metadata = {
  title: { absolute: "Certificazioni — Prodotti Digitali Fatti con Qualità | Mia-Care" },
  alternates: { canonical: "/it/certificazioni" },
  description:
    "Mia-Care possiede le certificazioni ISO 13485, ISO 27001 e ISO 9001, a dimostrazione del nostro impegno per la qualità, la sicurezza delle informazioni e la conformità del software medicale.",
};
...
const CERTS = [
  {
    ...
    body: "ISO 13485 garantisce la capacità di sviluppare e distribuire dispositivi medici e software soddisfacendo i requisiti del cliente e i requisiti regolatori applicabili derivanti dall'MDR. Lo scopo principale di questo standard è facilitare la certificazione di soluzioni digitali che comunicano con dispositivi medici armonizzati per i sistemi di gestione della qualità. Mia-Care sta attualmente aiutando diverse aziende a ottenere la certificazione per Software as a Medical Device, costruendo nuovi prodotti digitali pronti per l'MDR con una suite software compliant-by-design.",
  ...
  },
  {
    ...
    body: "Questa certificazione rappresenta lo standard internazionale che descrive le best practice per un Sistema di Gestione della Sicurezza delle Informazioni. Attraverso questa ISO dimostriamo la conformità alle best practice di sicurezza delle informazioni in linea con gli obiettivi aziendali. La certificazione è stata integrata con i controlli richiesti dalle linee guida ISO/IEC 27017:2015 e ISO/IEC 27018:2019, che estendono l'ambito fornendo controlli e linee guida specifici per garantire la sicurezza delle informazioni e la protezione dei dati personali all'interno dei servizi cloud.",
  ...
  },
  {
    ...
    scope:
      "Progettazione e sviluppo, produzione, installazione e manutenzione di software medicale e software per dispositivi medici.",
    body: "Lo standard ISO 9001 definisce i requisiti minimi che un'organizzazione deve soddisfare per garantire la qualità dichiarata del prodotto e del servizio offerto. Questa certificazione è dedicata al miglioramento continuo e costante dell'azienda, ottimizzando la struttura organizzativa e dotandola degli strumenti per renderla più efficiente nel tempo, in base al ritmo di crescita.",
    ...
    <>
      ...
      >
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            Prodotti Digitali Fatti con Qualità
          </h1>
          <p
            className="text-lg max-w-2xl"
            style={{ color: "var(--text-secondary)", lineHeight: 1.75 }}
          >
            Mia-Care è profondamente impegnata a garantire i più alti standard di qualità nelle
            attività che coinvolgono partner e clienti. L'esperienza acquisita in anni di attività
            ha permesso al nostro team R&D di coniugare eccellenza tecnica e processi certificati
