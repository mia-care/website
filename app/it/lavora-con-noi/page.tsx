...
export const metadata: Metadata = {
  title: { absolute: "Lavora con Noi — Unisciti alla Rivoluzione della Sanità | Mia-Care" },
  alternates: { canonical: "/it/lavora-con-noi" },
  description:
    "Unisciti a Mia-Care e aiutaci a costruire la piattaforma di compliance AI-native per Software as a Medical Device. Posizioni aperte a Milano tra engineering e prodotto.",
};

const VALUES = [
  {
    title: "Trasparenza e Inclusione",
    body: "Un ambiente di lavoro inclusivo aiuta le persone a sentirsi valorizzate e incoraggia la creatività. Ci impegniamo anche a mantenere la massima apertura tra manager e team.",
  },
  {
  ...
  },
  {
    ...
    body: "Scrivere codice di alta qualità e migliorare continuamente sono i pilastri principali del nostro lavoro. Ciononostante, siamo sinceramente impegnati a migliorare la qualità delle cure per tutte le persone.",
  },
];
    ...
    <>
      ...
      >
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            Unisciti alla rivoluzione della sanità
          </h1>
          <p
          ...
          >
            <div>
              ...
              <p className="text-sm" style={{ color: "rgba(0,0,0,0.6)" }}>
                Non trovi un ruolo che ti si adatta? Candidati spontaneamente — siamo sempre alla
                ricerca di persone eccezionali.
              </p>
            </div>
            <a
