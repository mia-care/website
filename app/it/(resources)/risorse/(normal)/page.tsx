...
export const metadata: Metadata = {
  title: { absolute: "Competence Center: whitepaper e video | Mia-Care" },
  description:
    "Accedi alla libreria di whitepaper e video di Mia-Care su compliance SaMD, interoperabilità FHIR, telemedicina e sanità cloud-native.",
  alternates: {
    canonical: "/it/risorse",
    languages: localeAlternates("/it/risorse"),
  },
};
