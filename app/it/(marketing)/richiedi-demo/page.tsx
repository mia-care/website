...
export const metadata: Metadata = {
  title: { absolute: "Richiedi una Demo: Compliance by Design nel tuo Contesto | Mia-Care" },
  description:
    "Prenota una sessione live su P4SaMD calibrata sul tuo contesto regolatorio. Risposte concrete su EU MDR, FDA, ISO 13485, IEC 62304 ed EU AI Act.",
  alternates: { canonical: "/it/richiedi-demo", languages: localeAlternates("/it/richiedi-demo") },
};

const VALUE_PROPS = [
  "Una sessione live di 1 ora con un solution architect P4SaMD, non una demo pre-registrata",
  ...
  "Un percorso di implementazione pensato per le dimensioni e i tempi del tuo team",
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-start">
          ...
          >
            ...
            <HubSpotForm
              portalId="5308597"
              formId="51cf1ae8-9a34-4134-8053-f9b8b49ff831"
              region="eu1"
            />
          </div>
        </div>
