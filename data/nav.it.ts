...
export const navItems: NavItem[] = [
  ...
  },
  {
    ...
    activeRoot: "/it/use-cases",
    dropdown: [
      { label: "Sviluppo SaMD Greenfield", href: "/it/use-cases/greenfield-samd" },
      { label: "Software AI ad Alto Rischio (CDSS)", href: "/it/use-cases/high-risk-ai-cdss" },
      { label: "Remediation di Software Legacy", href: "/it/use-cases/legacy-remediation" },
    ],
  },
